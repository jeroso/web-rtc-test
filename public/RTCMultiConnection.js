...
(function() {
    ...
    window.RMCDefaultChannel = 'lucid-dream-vr-share-web';
    ...
    window.RTCMultiConnection = function(channel) {
        ...
        console.log("channel::"+ connection.channel);
    ...
    function setDefaults(connection) {
        ...
        connection.resources = {
            ...
            firebaseio: 'https://unique-venue-e62b4-default-rtdb.firebaseio.com/',
